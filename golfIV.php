...
<body>
                    ...
                    <div class="dropdown">
                        <li class="nav-item">
                            ...
                            <ul class="dropdown-menu nav-item">
                                <li class="nav-link active"><a href="golfIV.php">Golf IV</a></li>
    ...
    <header class="py-5 bg-image-full" style="background-image: url('img/mk4.jpg');">
    ...
    <section class="py-5">
        <div class="container">
            <h1>Golf IV</h1>
            <p>Lansat în 1999, Volkswagen Golf IV (sau Volkswagen Golf MK4) a fost cea mai bine vândută mașină în Europa în anul 2001 (deși a ajuns pe locul al doilea, în spatele Peugeot 206, în 2002). Golf MK4 era mai modern și mai bine dotat decât versiunile precedente Mk1, Mk2 și Mk3. Cumpărătorii au avut la dispoziție o gamă largă de caroserii tip cabrio, tip universal, tip special R32 și altele. În total au fost fabricate 4.300.000 unități.</p>
            <h5>Pozele cu masinile celor ce ne sustin:</h5>
            <table class="table">
                <?php
                require_once 'help/imagesClass.php';
                $dbpoze = new imagesClass();
                $results = $dbpoze->getImageType('golfIV');
                            ...
                            if (isset($_SESSION['user'])) {
                                if ($_SESSION['admin'] > 1) {
                                    ...
                                    <form method="get" action="help/delete_image.php">
                                        <input type="hidden" name="model" value="golfIV">
